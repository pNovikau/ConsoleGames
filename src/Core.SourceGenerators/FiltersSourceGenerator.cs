...
{
    [Generator]
    public class FiltersSourceGenerator : IIncrementalGenerator
    {
        private const string GenerateComponentsFilterAttribute = "Core.Ecs.ComponentFilters.GenerateComponentsFilterAttribute";
        ...
        private static void Execute(Compilation compilation, ImmutableArray<ClassDeclarationSyntax> classes, SourceProductionContext context)
        {
            ...
            foreach (var classSymbol in classes.Distinct())
            {
                ...
                componentFiltersContentBuilder.Add(constraintClauses);
            }
